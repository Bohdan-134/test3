...
// doorSale3.innerHTML=discount==='50%'?'15%':'25%'}else if(door2.classList.contains('open')){doorSale2.innerHTML=discount
// doorSale1.innerHTML=discount==='50%'?'15%':'25%'
// doorSale3.innerHTML=discount==='50%'?'25%':'50%'}else if(door3.classList.contains('open')){doorSale1.innerHTML=discount==='50%'?'25%':'50%'
// doorSale3.innerHTML=discount
// doorSale2.innerHTML=discount==='50%'?'15%':'25%'}})
